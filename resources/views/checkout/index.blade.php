                ...
                <div class="container">
                    ...
                    <div class="row g-4">
                                ...
                                @forelse ($cart as $item)
                                    <li class="list-group-item d-flex justify-content-between align-items-start lh-sm">
                                        <div class="me-auto"> {{-- Pushes content to the left --}}
                                            <h6 class="my-0 text-dark">{{ $item->post->title ?? 'Menu Tidak Ditemukan' }}
                                            </h6>
                                        ...
                                        <span class="text-nowrap ms-2">Rp
                        ...
                        <div class="col-md-7 col-lg-8">
                            ...
                            <form action="{{ route('checkout.storeCustomerData') }}" method="POST" class="needs-validation"
                                novalidate>
                                @csrf

                                <div class="row g-3">
                                    <div class="col-12">
                                        <label for="customer_name" class="form-label">Nama <span
                                    ...
                                    <div class="col-12">
                                        <label for="customer_whatsapp" class="form-label">Nomor WhatsApp <span
                                                class="text-danger">*</span></label>
                                        <input type="tel" class="form-control" name="customer_whatsapp"
                                            id="customer_whatsapp" placeholder="Cth: 081234567890"
                                            value="{{ old('customer_whatsapp') }}" required pattern="[0-9]{10,15}"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        @error('customer_whatsapp')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @else
                                            <div class="invalid-feedback">Harap masukkan nomor WhatsApp yang valid (hanya angka,
                                                10-15 digit).</div>
                                        @enderror
                                    </div>

                                    <div class="col-12">
                                        <label for="customer_email" class="form-label">Email <span class="text-muted">(untuk
                                                pengiriman struk)</span></label>
                                ...
                                <div class="d-flex gap-3 mb-3">
                                    ...
                                    <button class="btn btn-secondary btn-lg flex-fill" type="submit">Cash</button>
                                    <button class="btn btn-warning btn-lg flex-fill" type="submit" name="payment_method"
                                        value="digital">
                                        Digital
                                    </button>
                                </div>

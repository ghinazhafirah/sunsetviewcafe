        ...
        <div class="row mb-3">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="position-relative">
                    <input type="text" class="form-control ps-5 search-input" wire:model.debounce.500ms="search" id="searchInput" placeholder="Cari nama, WA, metode, atau tanggal...">
        ...
        <div class="container bg-light rounded mt-4 p-3">
            ...
            <div class="table-responsive">
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    ...
                    <tbody>
                        @forelse ($orders as $transaction) {{-- Gunakan @forelse untuk menangani data kosong --}}
                            <tr class="text-center">
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dashboard.show', $transaction->uuid) }}" class="btn badge bg-info">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                                <td>

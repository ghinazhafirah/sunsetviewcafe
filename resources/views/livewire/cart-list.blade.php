                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <button wire:click="decreaseQuantity({{ $item->id }})" class="btn btn-light border-0 px-1">-</button>
                                <input type="text" value="{{ $item->quantity }}" class="form-control text-center mx-1" style="width: 50px;" readonly>
                                <button wire:click="increaseQuantity({{ $item->id }})" class="btn btn-light border-0 px-1">+</button>
                            </div>
                        </td>

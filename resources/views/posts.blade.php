                        ...
                        <div class="carousel-inner">
                            @foreach ($posts as $key => $post)
                                <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                    ...
                                    @else
                                        <img src="{{ asset('img/notavailable.png') }}" class="d-block w-100"
                                            style="height: 300px; object-fit: contain; background-color: #eee;"
...
<script>
    ...
    /// * Menambahkan listener untuk pageshow
    window.addEventListener('pageshow', function(event) {
        console.log(event);
        console.log('Kalo besar nanti, aku mau jadi jemboud');
    });
</script>

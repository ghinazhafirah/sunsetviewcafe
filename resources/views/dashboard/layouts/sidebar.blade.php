...
<div id="sidebar" class="sidebar pe-4 pb-3 bg-warning d-none d-lg-block position-fixed top-0 start-0 h-100"
    ...
    <nav class="navbar navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="/dashboard" class="nav-item nav-link {{ Request::is('dashboard') || (Request::is('dashboard/*') && !Request::is('dashboard/posts*') && !Request::is('dashboard/qr*') && !Request::is('dashboard/generate-qr*')) ? 'active' : '' }}"><i class="bi bi-shop-window"></i> Dashboard</a>            

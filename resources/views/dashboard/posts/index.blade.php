        ...
        <div class="bg-light rounded mt-4 p-3">
            ...
            <div class="row g-2 align-items-center mb-3">
                ...
                <div class="col-12 col-md-auto">
                    <a href="/dashboard/posts/create" class="btn btn-warning w-100"><i class="bi bi-plus-square"></i> New Menu</a>
                </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
                                    <button class="btn badge bg-danger" onclick="return confirm('Apakah tetap menghapus Menu?')"><i class="bi bi-x-square"></i></button>
                                </form>                                
                            </td>
                        </tr>
                        @endforeach

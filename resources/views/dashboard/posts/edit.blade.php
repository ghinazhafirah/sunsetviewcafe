    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data"> 
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="price" id="price" value="{{ old('price', $post->price ?? '') }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-3 align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <label class="btn btn-outline-success rounded-circle d-flex align-items-center justify-content-center" 
            ...
            <input type="body" class="form-control @error('body') is-invalid @enderror" type="hidden" name="body" required value="{{ old('body', $post->body) }}">
                @error('body')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
